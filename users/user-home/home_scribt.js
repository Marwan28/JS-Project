...
window.addEventListener("scroll", function () {
  ...
  function showBGContentH1(){
      document.querySelector("#BG-text h1").innerHTML="Welcome to ShopHub";

  };
    window.onload=setTimeout(showBGContentH1,500);

    function showBGContentP(){
      document.querySelector("#BG-text p,#BG-text button").innerHTML="Your one-stop shop for everything you need";

  };
    window.onload=setTimeout(showBGContentP,1000);
    ...
    window.onload=setTimeout( showBGContentButton,1500);
    ...
    var categoriesData,categoryLength;
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState === 4) {
        if (xhr.status === 200) {
          ...
          categoryLength=categoriesData.length ;
          console.log(categoryLength);
          var numyello = document.querySelector("#yello").innerHTML=categoryLength;
          ...
          document.querySelector("#categoriesGrid").appendChild(card);
        }
